...
export const Route = createFileRoute(
  ...
  component: OrderPaymentDetailPage,
});

function OrderPaymentDetailPage() {
  ...
  const paymentQuery = useQuery(orderPaymentQueryOptions(orderId, paymentId));
  ...
  const deleteMutation = useMutation({
    mutationFn: async () => {
      ...
      if (response.error) throw new Error("Failed to delete payment");
    },
    onSuccess: () => {
        ...
        {canWrite && (
          <div className="flex items-center gap-2">
            <Button variant="outline" asChild>
              <Link
                to="/orders/$orderId/payments/$paymentId/edit"
